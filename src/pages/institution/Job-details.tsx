...
import { deleteInstitutionJob, viewInstitutionJobDetails } from "../../api/institution";
...
const JobDetails: React.FC = () => {
  ...
  const { mutate: deleteJob, isPending: isDeleting } = deleteInstitutionJob();
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-white rounded-lg p-6 border">
            ...
            <div className="gap-4 flex">
              <button
                onClick={()=> navigate(`/institution/jobs/edit/${jobId}`) }
