...
import { getGeneralUsers } from "../../api";
...
const GeneralUsers = () => {
  ...
  const generalUsers = useGetData(["general"], getGeneralUsers);
  ...
  useEffect(() => {
    ...
    if (generalUsers.data) {
      const mergedData: DataItem[] = [...generalUsers.data.data];
  ...
  }, [generalUsers.data]); // Dependency array ensures this runs when data updates
                              ...
                              <MenuList>
                                <MenuItem className="flex flex-col gap-3">
                                  <span
                                    ...
                                    onClick={() =>
                                      navigate(
                                        `/super-admin/user-details/${item.id}`
                                      )
                                    }
                                  >
                                    View Details
