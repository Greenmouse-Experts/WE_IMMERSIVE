...
const DeclineRequets = ({ onClose, assetData }: { onClose: (status: boolean) => void; assetData: any }) => {
    ...
    const onSubmit = (formData: any) => {
        ...
        mutation.mutate({ ...formData, assetId: assetData?.asset.id, status: "unpublished" });
    };
