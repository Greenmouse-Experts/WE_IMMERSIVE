...
const AllUsers = () => {
  ...
  const institutions = useGetData(["institutions"], getInstitutions);
  ...
  }, [generalUsers.data, students.data, creators.data, institutions.data]); // Dependency array ensures this runs when data updates
