...
const AllInstitutions = () => {
  ...
  useEffect(() => {
    ...
    if (institutions.data) {
      const mergedData: DataItem[] = [...institutions.data.data];
  ...
  }, [institutions.data]); // Dependency array ensures this runs when data updates
              ...
              <table className="table-auto md:w-full w-[1000px] text-sm">
                <thead>
                  <tr className="bg-gray-100 dark:bg-gray-800">
                    ...
                    <td className="unbound p-1 pb-2">Industry Type</td>
