...
interface AboutPhysicalAssetProps {
  handleStepper: (direction: string) => void;
  payload: any;
}
const AboutPhysicalAsset = ({
  handleStepper,
  payload,
}: AboutPhysicalAssetProps) => {
        ...
        <div className="flex flex-col gap-4 mt-5">
          ...
          <div className="mt-5">
            ...
            <div className="mt-6">
              ...
              <div
                className="h-[274px] w-[427px] border-primary border-dashed border rounded-[10px] overflow-hidden flex flex-col items-center justify-center cursor-pointer relative"
                onClick={() => openFilePicker(assetUploadRef)}
              >
                {assetUpload ? (
                  <img
                    src={assetUpload}
...
export default AboutPhysicalAsset;
