...
const AboutIndex = () => {
  return (
    <div className="">
      <AboutBanner/>
      <div id="whole_package" className="bg-[white] w-[85%] m-auto text-center py-[5%]">
      ...
      <div id="empowering_creators" className="w-[85%] mx-auto mt-5 mb-[7%]">
        <div>
      ...
      <div className="bg-[#E9EBFB] py-[5%]">
        <div className="flex items-top w-[85%] mx-auto">
            ...
            <div className="w-[50%]">
                ...
                <h1 className="unbound text-[40px] font-[500] leading-[1.3] mb-8 pr-[10%]">Unlock your full potential</h1>
                <div className="mt-5">
                    {
      ...
      <div>
        <div className="flex flex-col text-center">
            ...
            <div>
                <h1>Join Us Today</h1>
                <p>Start your journey on WE.IMMERSIVE and access tools designed for creative professionals:</p>
            </div>
        </div>
        <div>
            <JoinCard/>            
