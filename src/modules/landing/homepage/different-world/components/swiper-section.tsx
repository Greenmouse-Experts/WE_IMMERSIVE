  ...
  const items = [
    {
      ...
      title: "Chukka Uzo",
      profile:
        "https://res.cloudinary.com/do2kojulq/image/upload/v1729006630/WE%20Immersive/F16CB5E3-D175-4ADA-AC99-272BB7542F01_2_g8hta5.png",
    },
    {
      image:
            ...
            >
              <div
                className={`rounded-[30px] relative flex items-end w-full h-full overflow-hidden ${
                  getActives().includes(i) ? "duration-100" : "mt-20 !h-[250px]"
                }`}
              >
