      ...
      <div className="overflow-y-auto max-h-[60vh] md:max-h-none">
        {courseModules?.map((module: IModule, index: number) => (
          <div key={index} className="mb-3">
            <button
              className="flex justify-between items-center w-full text-left text-gray-700 dark:text-white font-medium py-2 focus:outline-none bg-lightPrimary px-3 rounded-tr-lg rounded-br-lg"
