    ...
    <div>
     <header className="shadow-sm">
        ...
        <div className="w-full bg-gray-300 h-16 md:h-24 lg:h-32 flex items-center justify-center mt-[8%]">
          <div className="absolute bg-white bg-opacity-80 right-[81%] md:right-5 lg:right-9 top-[12%] md:top-[16%] lg:top-[19%] flex items-center justify-center gap-3 text-[#1D9CD7] text-[20px] rounded-[10px] w-[42px] md:w-[209px] lg:w-[209px] h-[35px] md:h-[59px] lg:h-[59px]">
