    ...
    <div className="min-h-screen w-[100%]">
      <main className="px-0 bg-white rounded-[20px] md:px-4 lg:px-4 py-8 flex flex-col md:flex-row gap-6">
        <section className="w-[100%] p-3">
            ...
            <div className="flex flex-col md:flex-row xl:flex-row md:gap-4 md:flex-wrap xl:flex-nowrap md:pt-4 xl:gap-4 items-center justify-between md:justify-center mt-11">
                {
                    cards.map((card, index) => (
                        <div key={index} className="flex flex-col mt-4 items-center md:w-1/3 justify-center rounded-[15px] w-[200px] xl:w-[200px] md:h-[118px] h-[169px] lg:h-[130px] bg-[#E9EBFB]">
