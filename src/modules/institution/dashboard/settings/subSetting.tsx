          ...
          <div className="shadow-sm rounded-md p-2 md:p-3 xl:p-8">
            ...
            <div className="flex gap-11 border-b pb-2 mb-4">
              <button
                ...
                className={`pb-2 text-[13px] xl:text-[18px] font-[400] cursor-pointer ${
            ...
            {activeTab === 'reset-password' && (
              <form className="space-y-4">
                ...
                <div className='xl:flex items-center justify-between xl:pt-4'>
            ...
            {activeTab === 'bank-details' && (
              <div className="space-y-4">
                ...
                <div className='xl:flex items-center justify-between xl:pt-4'>
                  ...
                  <div className='w-[100%] xl:w-[48%] pt-3 xl:pt-0'>
                    <label
                        htmlFor="email"
                        className="Mulish block text-[14px] xl:text-[18px] mb-2 font-[400] text-gray-700"
                    >
