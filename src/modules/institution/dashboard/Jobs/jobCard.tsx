...
const JobCard = ({
  ...
  return (
    <div className="bg-white dark:bg-black rounded-xl shadow-md p-2 md:p-3 lg:p-3 xl:p-8 border border-gray-200 relative">
      ...
      <div className="flex justify-between gap-1 md:gap-4 lg:gap-4">
        <button onClick={() => navigate(`/institution/job/view/${id}`)} className="unbound px-4 py-2 w-[292px] border border-[#BDBDBD] text-[#7B7B7B] dark:text-white rounded-md text-[10px] lg:text-[12px] xl:text-[13px]">
          See Details »
        </button>
        <button className="unbound px-4 py-2 w-[292px] border border-[#BDBDBD] text-[#7B7B7B]  dark:text-white rounded-md text-[10px] lg:text-[12px] xl:text-[13px]">
          See Bids (10) »
        </button>
      </div>
