        ...
        <div className="mt-6">
                ...
                <div className="flex flex-col md:flex-row lg:flex-row justify-between mt-5 mb-14 items-center">
                    <div className="flex flex-col md:flex-col lg:flex-col xl:flex-row items-center">
                        <p className="unbound text-[#06052A] text-[24px] md:text-[17px] lg:text-[15px] xl:text-[24px]">Created Courses</p>
                ...
                <table className="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <td className="unbound p-1 pb-2 whitespace-nowrap text-[12px] md:text-[13px] xl:text-[17px]">Courses Name</td>
                        ...
                        <td className="unbound p-1 pb-2 whitespace-nowrap text-[12px] md:text-[13px] xl:text-[17px]">Courses Income</td>
