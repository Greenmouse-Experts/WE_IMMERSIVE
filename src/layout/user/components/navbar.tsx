    ...
    <div className="flex items-center justify-end w-full bg-white dark:bg-gray-900 p-4 rounded-lg mb-5">
      ...
      <div className="hidden md:block">
        <input
          ...
          className="w-[250px] px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
        />
      </div>

      {/* Icons and Profile - Inline on all screens & Right-aligned */}
      <div className="flex items-center gap-3 md:gap-4 ml-auto">
        {[CiSearch, BsGear, IoMdNotificationsOutline].map((Icon, index) => (
          <div
            key={index}
